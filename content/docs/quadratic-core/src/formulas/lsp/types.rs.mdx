---
title: "types.rs"
description: "Types for Monaco editor LSP API. Monaco seems to use a *slightly different* protocol than standard LSP, and the only place I could find it documented was [th…"
